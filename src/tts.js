...
const PRONUNCIATION_FIXES = [
  ...
  ['житомира', 'жито́мира'],
  ['житомиру', 'жито́миру'],
  ['житомиром', 'жито́миром'],
  ['житомирі', 'жито́мирі'],
  ['житомирщина', 'жито́мирщина'],
  ['житомирщини', 'жито́мирщини'],
  ['житомирщині', 'жито́мирщині'],
  ['житомирський', 'жито́мирський'],
  ['житомирська', 'жито́мирська'],
  ['житомирської', 'жито́мирської'],
  ...
  ['кропивницький', 'кропивни́цький'],
  ['кропивницького', 'кропивни́цького'],
  ['кропивницькому', 'кропивни́цькому'],
  ['кропивницьким', 'кропивни́цьким'],
  ['кропивницька', 'кропивни́цька'],
  ...
  ["зінов['’ʼ]єв", "зіно́в'єв"],
  ["зінов['’ʼ]єва", "зіно́в'єва"],
  ["зінов['’ʼ]єву", "зіно́в'єву"],
  ["зінов['’ʼ]євим", "зіно́в'євим"],
  ["зінов['’ʼ]євськ", "зіно́в'євськ"],
  ["зінов['’ʼ]євська", "зіно́в'євська"],
  ["зінов['’ʼ]євський", "зіно́в'євський"],
  // Орудний відмінок («назвала його Зінов'євськом») окремим рядком: правило
  // «зінов'євськ» його не ловить — після нього стоїть літера, а межа слова
  // цього не дозволяє. Саме через це в ролику про Кропивницький назва
  // прозвучала не так, хоч називний відмінок у словнику вже був.
  ["зінов['’ʼ]євськом", "зіно́в'євськом"],
  ["зінов['’ʼ]євську", "зіно́в'євську"],
  ["зінов['’ʼ]євськи", "зіно́в'євськи"],
  ...
  ['єлисаветград', 'єлисаветгра́д'],
  ['єлисаветграда', 'єлисаветгра́да'],
  ['єлисаветграду', 'єлисаветгра́ду'],
  ['єлисаветградом', 'єлисаветгра́дом'],
  ['єлисаветграді', 'єлисаветгра́ді'],
  ['єлисаветградський', 'єлисаветгра́дський'],
  ['єлисаветградська', 'єлисаветгра́дська'],
  ['єлисаветградського', 'єлисаветгра́дського'],
  ...
  ['єлизавета', 'єлизаве́та'],
  ['єлизавети', 'єлизаве́ти'],
  ['єлизаветі', 'єлизаве́ті'],
  ['єлизавету', 'єлизаве́ту'],
  ['єлизаветою', 'єлизаве́тою'],
  ['єлисавета', 'єлисаве́та'],
  ['єлисавети', 'єлисаве́ти'],
  ['єлисаветі', 'єлисаве́ті'],
  ['єлисавету', 'єлисаве́ту'],
  ['єлисаветою', 'єлисаве́тою'],
  ...
  ['кіровоград', 'кіровогра́д'],
  ['кіровограда', 'кіровогра́да'],
  ['кіровограду', 'кіровогра́ду'],
  ['кіровоградом', 'кіровогра́дом'],
  ['кіровограді', 'кіровогра́ді'],
  ['кіровоградський', 'кіровогра́дський'],
  ['кіровоградська', 'кіровогра́дська'],
  ['кіровоградської', 'кіровогра́дської'],
  ['кіровоградщина', 'кіровогра́дщина'],
  ['кіровоградщини', 'кіровогра́дщини'],
  ['кіровоградщині', 'кіровогра́дщині'],
  // Григо́рій — наголос на «о».
  ['григорій', 'григо́рій'],
  ['григорія', 'григо́рія'],
  ['григорію', 'григо́рію'],
  ['григорієм', 'григо́рієм'],
