...
export async function generateNarration(theme) {
...
українська. Починається з «Чи знали ви, що …», далі 2–3 найвражаючі деталі
факту (цифри, порівняння), передостаннє речення починається з «Саме тому …»,
останнє — короткий заклик підписатися.
Без емодзі, без лапок, без заголовків — лише текст для читання вголос.`;
