...
const THEME_CATEGORIES = [
  ...
  'технології',
  'практичні факти, які стають у пригоді в повсякденному житті',
  'факти про Україну (природа, історія, культура, винаходи, рекорди)',
];

export async function generateTheme(usedTitles) {
  const category = THEME_CATEGORIES[Math.floor(Math.random() * THEME_CATEGORIES.length)];
