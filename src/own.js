...
як завжди. Якщо підтвердилось — працюй далі за звичайними правилами.`
  ...
  const step2 = hasStory
   ...
   Якщо у сюжеті власника є помилка — НЕ виправляй мовчки: постав статус
   ERROR і опиши проблему в «Примітці».`
    : `2. ПЕРЕВІР ФАКТИ веб-пошуком, перш ніж писати цифри й назви. ${budget}`;
