...
// До 12: стільки дозволяє промт сценарію (10–12 слайдів, з них останній —
// заклик). Межа мусить збігатися з промтом, інакше ChatGPT малює законні
// 11 кадрів, а монтаж їх відкидає — саме так стало відео про борщ. Довжина
// відео йде за озвучкою, тож ліміт лише страхує від «сміття» в архіві.
