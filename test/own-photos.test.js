...
test('промт малювання шукає рівно той маркер, який ставить код', async () => {
  ...
  // Другий шлях: власник міг докинути знімки прямо в чат, і тоді в колонці G
  // про них немає жодного слова — але це ті самі фото власника.
  assert.match(text, /ПРИКРІПЛЕНІ ДО ЦІЄЇ РОЗМОВИ/);
});
