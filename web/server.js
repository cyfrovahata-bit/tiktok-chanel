      ...
      try {
        ...
        if (step === 'submit') {
          ...
          await sendMessage(
            ...
            + 'Далі відкрий ChatGPT і запусти промт малювання фото — сам він '
            + 'власні сюжети не підхоплює. Він розіб\'є твій текст на слайди, '
            + 'перевірить факти й намалює кадри.',
          ).catch(() => {});
          return json(res, 200, out);
        }
