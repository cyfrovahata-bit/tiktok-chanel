...
| Terms of Service URL | `https://tiktok-chanel-production.up.railway.app/terms` |
...
Слотів **чотири окремих**, у кожен свій файл (JPEG, PNG або PDF).
Вимоги до якості: від 1280×720, чіткий текст, на скриншотах сайту —
**видимий адресний рядок браузера**.

| Слот | Що завантажити |
|---|---|
| Скриншоти політики конфіденційності | сторінка `/privacy` цілком |
| Скриншот головної | сторінка `/about` цілком — на ній одразу під заголовком видно і назву YouTube, і посилання на політику |
| Документація щодо умов використання | сторінка `/terms` цілком |
| Умовні документи (один файл) | PDF із трьох частин, див. нижче |

В останній слот ідуть саме ті пункти, які випливають із наших відповідей:

1. **OAuth** (бо відповіли «Да»): екран згоди Google зі списком прав плюс
   `myaccount.google.com/permissions`, де видно виданий доступ.
2. **Інтерфейс заливання** (сценарій «Загрузка видео»): мінідодаток у Telegram
   зі списком готових роликів.
3. *(не наш — програвач і вбудоване відео ми не використовуємо)*
4. **Панель керування** (сценарій «Внутренние инструменты»): головний екран
   мінідодатка.

Скриншоти інтерфейсу можуть бути українською — головне, щоб було видно, що це
за екран; текстові відповіді у формі мають бути англійською.
